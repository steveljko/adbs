...
<div class="inline-flex items-center space-x-1 px-2 py-1.5 bg-gray-100 rounded-md">
    <button id="list-view-btn"
        class="flex items-center space-x-1 p-1.5 rounded-md transition-colors duration-200 {{ request()->view_type === 'list' ? 'bg-white text-orange-500 shadow-sm' : 'text-gray-500 hover:bg-gray-200' }}"
    ...
    <button id="card-view-btn"
        class="flex items-center space-x-1 p-1.5 rounded-md transition-colors duration-200 {{ request()->view_type === 'card' ? 'bg-white text-orange-500 shadow-sm' : 'text-gray-500 hover:bg-gray-200' }}"
