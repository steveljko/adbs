...
@php
    $baseClasses =
        'inline-flex items-center justify-center border font-medium rounded shadow-sm transition-colors focus:outline-none focus:ring-1 disabled:opacity-50 disabled:cursor-not-allowed';
