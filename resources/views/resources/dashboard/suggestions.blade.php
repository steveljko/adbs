    ...
    <div class="p-2">
        <div class="space-y-1">
            @if (count($tags))
                ...
                @foreach ($tags as $tag)
                    <div class="px-3 py-2 hover:bg-gray-100 rounded cursor-pointer text-sm" tabindex="-1" role="option"
            ...
            @if (count($sites))
                ...
                @foreach ($sites as $site)
                    <div class="px-3 py-2 hover:bg-gray-100 rounded cursor-pointer text-sm" tabindex="-1"
                        role="option" hx-get="{{ route('dashboard.search.site', $site) }}"
